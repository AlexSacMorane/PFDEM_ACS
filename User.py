...
def All_parameters(overlap, chi, kappa_c):
    '''
    ...
    overlap_target = overlap #overlap verified before each phase field iteration
    chi = chi #coefficient applied to the chemical energy
    ...
    n_t_PFDEM = 1000 #number of cycle PF-DEM
    ...
    struct_element = np.array(np.ones((12,6)), dtype = bool)
    ...
    template = str(overlap)+'_'+str(int(100*chi))+'_'+str(kappa_c)+'_run' #template of the name of the simulation
